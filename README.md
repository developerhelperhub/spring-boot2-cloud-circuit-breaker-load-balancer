...
* Identity Service
 1. Login: POST: localhost:8081/auth/oauth/token
* API Gateway: testing invendory service
 1. Get all items : GET: localhost:8085/inventory/user/items
 2. Add new item : PUT: localhost:8085/inventory/user/items
 3. Get item by id : GET: localhost:8085/inventory/user/items/1
* API Gateway: testing sales service
 1. Get all items : GET: localhost:8085/sales/items
 2. Add new item : PUT: localhost:8085/sales/items
 3. Get item by id : GET: localhost:8085/sales/items/1
